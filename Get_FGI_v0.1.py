...
with open(file) as file:
    ...
    for line in file:
        ...
        if k3 in line and k4 not in line and phone_type != 'iphone':
            p = p3
            if not FGI_r10:
                FGI_r10 = p.findall(line)
                FGI_r10 = FGI_r10[0:32]
...
print(FGI, FGI_r9, FGI_r10)
FGI = p4.findall(FGI[0])
FGI_r9 = p4.findall(FGI_r9[0])
FGI_r10 = p4.findall(FGI_r10[0])

FGI_all = FGI + FGI_r9 + FGI_r10
